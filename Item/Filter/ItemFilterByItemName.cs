...
/// <summary>
/// Filters items using a RegEx on the return of `ItemName` on an item's descriptor.
/// </summary>
[Tool, GlobalClass]
public partial class ItemFilterByItemName : ItemFilterBase
{
    //
    //  Exports
    //
    ...
    public override FilterResult Evaluate(ItemInstance item, ItemInventory inventory)
    {
        ...
        var foundMatch = CompiledRegEx.Search(item.Descriptor.ItemName) != null;
